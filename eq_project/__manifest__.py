...
##############################################################################
{
    ...
    "depends" : ['base','project','project_issue','hr_timesheet_activity_begin_end','hr_timesheet_sheet', 'analytic','project_recalculate',
                 ...
                 'project_task_category','project_task_code','project_task_report','project_timeline','project_timesheet_time_control','project_parent','project_issue_sheet','eq_account'],  #no dependencies for stage was always in Project/Data/project_data.xml declared
    'data': [
