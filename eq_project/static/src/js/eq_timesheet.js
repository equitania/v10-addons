odoo.define('eq_project.sheet', function (require) {
    'use strict';
    ...
    core.form_custom_registry.get('weekly_timesheet').include({
        ...
        initialize_content: function() {
            ...
            return self.render_drop.add(new Model('account.analytic.line').call('default_get', [
                ['account_id','general_account_id','journal_id','date','name','user_id','product_id','product_uom_id','amount','unit_amount','is_timesheet','task_id', 'invoice_id'],
                    ...
                    var days = _.map(dates, function(date) {
                        ...
                        if (to_add) {
                            ...
                            day.lines.unshift(_.extend(_.clone(project_defaults), {
                                ...
                                invoice_id: false, // Equitania change
                            }));
                        }
                        return day;
                    });
